// src/lib.rs
/*
 * Core library for SonicTutorials
 */
...
#[derive(Debug)]
pub struct SonicTutorialsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SonicTutorialsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SonicTutorials processing");
    
    let mut processor = SonicTutorialsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SonicTutorialsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SonicTutorialsProcessor::new(false);
